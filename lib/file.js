...
File.prototype = {
  ...
  set readOnly( value ) { return this.setFlag( File.RDONLY, value ) },

  get hidden() { return this.getFlag( File.HIDDEN ) },
  set hidden( value ) { return this.setFlag( File.HIDDEN, value ) },

  get system() { return this.getFlag( File.SYSTEM ) },
  set system( value ) { return this.setFlag( File.SYSTEM, value ) },

  get arch() { return this.getFlag( File.ARCH ) },
  set arch( value ) { return this.setFlag( File.ARCH, value ) },

  get exec() { return this.getFlag( File.EXEC ) },
  set exec( value ) { return this.setFlag( File.EXEC, value ) },

  get utfName() { return this.getFlag( File.UNICODE ) },
  set utfName( value ) { return this.setFlag( File.UNICODE, value ) },
