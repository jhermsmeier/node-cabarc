...
File.prototype = {
  ...
  parse( buffer, offset ) {
    ...
    this.date = buffer.readUInt16LE( offset + 12 )
    this.time = buffer.readUInt16LE( offset + 14 )
    this.attributes = buffer.readUInt16LE( offset + 16 )

    var nameEnd = buffer.indexOf( 0x00, offset + 18 )

    this.name = buffer.toString( 'utf16le', offset + 18, nameEnd )
